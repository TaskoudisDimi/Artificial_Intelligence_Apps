...
# with open('C:/Users/chris/Desktop/Dimitris/Tutorials/AI/Computational-Intelligence-and-Statistical-Learning/WebApp/model.h5','rb') as f:
#     clf = pickle.load(f)
...
@app.route('/SVM_Classification')
def SVM_Classification():
    return render_template('SVM_Classification.html')
